...
local function onpreload(inst, data)
    ...
    if data.creaturename then
        ...
        inst.creaturename = "annosoulball"
    end
    inst.name = inst.creaturename
...
local function onsave(inst, data)
    ...
    if inst.creaturename then
        ...
        data.creaturename = "annosoulball"
    end
...
local function OnDrop(inst)
    ...
    if inst and inst.sealcreature and inst.sealcreature ~= 0 then
        ...
        instcreature.prefab = 'annosoulball'
...
return Prefab("common/inventory/annosoulball", fn, assets, prefabs)
